...
public class OrgUserMgServiceImpl extends OrgBaseService implements IOrgUserMgService {
	...
	public List queryLikeZhengzhi(ParamDTO dto) {
		String positionnamelike = (dto.getAsString("positionnamelike") == null) || ("".equals(dto.getAsString("positionnamelike"))) ? dto
				.getAsString("positionnamelike1") : dto.getAsString("positionnamelike");
