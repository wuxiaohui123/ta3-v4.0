...
public class DomainMeta implements Serializable {
	...
	public String toString() {
		...
		buffer.append("领域对象名:" + getDomainName() + "\n").append("对应数据库表名:" + getTableName() + "\n")
				.append("中文名:" + getComment() + "\n").append("字段描述如下\n");
	...
	public static class FieldMeta {
		...
		public String toString() {
			return new ToStringBuilder(this).append("字段名称:", getFieldName()).append("数据库列名:", getColumnName())
					.append("中文名:", getComment()).append("java数据类型:", getJavaType()).append("数据库列类型:", getDbType())
					.append("长度:", getLength()).append("是否主键:", isPrimaryKey() == true ? "是" : "否")
					.append("是否非空:", isNotEmpty() == true ? "是" : "否").append("是否是代码:", isCode() == true ? "是" : "否")
					.append("\n").toString();
		}
	}
}
