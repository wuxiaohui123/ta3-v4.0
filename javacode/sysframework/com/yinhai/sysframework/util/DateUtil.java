...
public class DateUtil extends DateUtils {
	...
	public static java.util.Date getDate(String month, String day, String year, String hour, String minute,
			String second) {
		int iYear = Integer.parseInt(year);
		int iMonth = Integer.parseInt(month);
		int iDay = Integer.parseInt(day);
	...
	public static java.util.Date stringToDate(String strDate, String srcDateFormat) {
	...
	public static String getDateTimeDisp(String datetime) {
		...
		return formatter.format(new java.util.Date(datel));
	}
	...
	private static int compute(java.util.Date arg1, java.util.Date arg2, int computeFlag, boolean bExact) {
	...
	public static int computeYear(java.util.Date arg1, java.util.Date arg2, boolean bExact) {
	...
	public static int computeMonth(java.util.Date arg1, java.util.Date arg2, boolean bExact) {
	...
	public static int computeDay(java.util.Date arg1, java.util.Date arg2) {
	...
	public static int computeMonthOnly(java.util.Date dateBegin, java.util.Date dateEnd) {
		Calendar ca1 = Calendar.getInstance();
	...
	public static int computeMonthOnly(java.util.Date dateBegin, java.util.Date dateEnd, boolean bWith) {
	...
	public static int computeMonthOnly(String dateBegin, String dateEnd, String format, boolean bWith) {
		...
		if (bWith) {
			java.util.Date begin = stringToDate(dateBegin, format);
			java.util.Date end = stringToDate(dateEnd, format);
	...
	public static int computeYearOnly(java.util.Date dateBegin, java.util.Date dateEnd) {
		Calendar ca1 = Calendar.getInstance();
		ca1.setTime(dateBegin);
		ca1.set(5, 1);
		ca1.set(2, 1);
	...
	public static int computeYearOnly(java.util.Date dateBegin, java.util.Date dateEnd, boolean bWith) {
	...
	public static int computeDateOnly(java.util.Date dateBegin, java.util.Date dateEnd) {
		Calendar ca1 = Calendar.getInstance();
		ca1.setTime(dateBegin);
		ca1.set(10, 0);
		ca1.set(12, 0);
	...
	public static int computeDateOnly(java.util.Date dateBegin, java.util.Date dateEnd, boolean bWith) {
