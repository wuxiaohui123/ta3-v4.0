...
public class StringUtil extends StringUtils {
	...
	public static String StringArrayToString(String[] strarr,String commString){
		String result = "";
	...
	public static String[] split(String str,String commString){
		return StringUtils.split(str, commString);
	}
	public static String splitJointStringByNumber(String str,String separator,int number){
		String result = "";
	...
	public static String splitJointStringByStringArray(String[] str,String connector,String stitch,String separator,boolean isAfter){
		String result = "";
		for (int i = 0; i < str.length; i++) {
			if(isAfter){
				result += (str[i] + connector + stitch);
				if(i!=str.length-1){
					result += separator;
				}
			}else{
				result += (separator + str[i] + connector + stitch);
			}
		}
		return result;
	}
	...
	public static String getFromatString(String str){
