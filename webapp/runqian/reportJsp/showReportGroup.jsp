...
<%
	...
	//判断是否需要填报
	String isinput="";
	String reportPath = request.getRealPath("/runqian/reportFiles/"+report);
	ReportGroup rg=null;
			...
			if(rd==null){
			   if(urltype== SubReportConfig.TYPE_ABSOLUTE){
				  ...
				  String url =   application.getRealPath("/runqian/reportFiles/"+rg.getReportMetaData().getSubReportConfig(0).getURL()) ;
                   ReportDefine rd2 = (ReportDefine)ReportUtils.read(url);
				   System.out.println(rd2);
				   if(rd2.getInput()==ReportDefine.INPUT_NORMAL){
						isinput="yes";
