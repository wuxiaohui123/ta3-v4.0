require.config({
	baseUrl : Base.globvar.basePath + "ta/resource/external/plugin",
	paths : {
		// plugin：ta-api-all
		...
		"api.listview" :"ta-api-all/api.listview",
		// plugin：ta-base-all
...
//		"echarts-all" : "ta-echart-all/echarts-all",
//		"echarts" : "ta-echart-all/echarts",

		// plugin：ta-form-all
		"datetimeMask" : "ta-form-all/datetimeMask",
		"issue" : "ta-form-all/issue",
		"moneyInput" : "ta-form-all/moneyInput",
		...
		"ajaxfileupload" : "ta-form-all/ajaxfileupload",
		...
		"grid.pager.expdata" : "ta-grid-all/grid.pager.exportdata",
		"grid.pager.impdata" : "ta-grid-all/grid.pager.importdata",
		...
		"scrollable" : "ta-other/jquery.scrollable.1.2.5",
		"listView":"ta-other/jquery.listview",
		...
		"hint-tip": "ta-tools-all/hint-tip",
