...
<head>
<title>供养亲属待遇审批</title>
<%@ include file="/ta/inc.jsp"%>
</head>
<body style="margin:0px;padding:0px" class="no-scrollbar">
	<ta:pageloading />
	<ta:toolbar id="tlb">
		<ta:button id="saveBtn" key="待遇审核[S]" icon="icon-save" hotKey="S" onClick="submitData();"  asToolBarItem="true" />
	...
	<ta:form id="form1" fit="true" >
	    ...
	    <ta:fieldset key="审核信息" cols="4" id="fltjb">
			<ta:selectInput id="aae016" key="审核标志" required="true" collection="ACTION" span="2" />
		...
		<ta:fieldset id="grjbxx" key="死亡人员信息" cols="3" cssStyle="margin-left:3px" >
		  <ta:text id="aac001" key="个人编号" readOnly="true" />
		  <ta:text id="aac003" key="姓名" readOnly="true"/>
		  <ta:text id="aab999" key="单位管理码" readOnly="true" />
		  <ta:text id="aac002" key="身份证号码" readOnly="true" />
		  <ta:text id="aae044" key="单位名称" readOnly="true" span="2"/>
		  <ta:text id="aab001" key="单位ID" readOnly="true" display="false" />
		  <ta:date id="aae138" key="死亡时间" readOnly="true"/>
			<ta:selectInput id="yac551" key="丧葬方式" collection="YAC551" required="true" readOnly="true"/>
			<ta:text id="yac001" key="最大发放期" cssStyle="margin-top:8px" readOnly="true"  />
			<ta:selectInput id="aae140" key="险种" collection="AAE140"  readOnly="true" display="false" />
	    </ta:fieldset>
		
		<ta:panel id="gyqsdyxx" key="供养亲属当前待遇信息" height="153px" bodyStyle="margin:0px" >
	      <ta:datagrid id="gyqsdyxxList" fit="true">
	          	<ta:datagridItem id="aac003" key="姓名" > </ta:datagridItem>
	          	<ta:datagridItem id="aac002" key="身份证" > </ta:datagridItem>
	          	<ta:datagridItem id="aaa036" key="待遇项目" collection="AAA036" > </ta:datagridItem>
	          	<ta:datagridItem id="aae128" key="计算金额" > </ta:datagridItem>
	          	<ta:datagridItem id="aae129" key="核发金额" > </ta:datagridItem>
	          	<ta:datagridItem id="aic172" key="享受比例" > </ta:datagridItem>
	          	<ta:datagridItem id="aac086" key="孤寡标志" collection="AAC086" > </ta:datagridItem>
	          	<ta:datagridItem id="aae144" key="供养关系" collection="AAE144"  > </ta:datagridItem>
	          	<ta:datagridItem id="yac520" key="丧失劳动" collection="YAC520" > </ta:datagridItem>
	          	<ta:datagridItem id="aae210" key="开始年月" > </ta:datagridItem>
	          	<ta:datagridItem id="aae235" key="结束年月" > </ta:datagridItem>
...
function submitData(){
	...
	Base.submit("form1", "familyTreamtCheck2Action!toSave.do");
}
