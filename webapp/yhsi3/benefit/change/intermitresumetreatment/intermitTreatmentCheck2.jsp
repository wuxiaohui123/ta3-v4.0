...
<head>
<title>IntermitTreatmentCheck2</title>
...
<body>
	<ta:pageloading />
	<ta:toolbar id="tlb">
		<ta:button id="saveBtn" key="待遇停发审批[S]" icon="xui-icon-spotSave" hotKey="ctrl+S" onClick="transProcess();"  asToolBarItem="true" />
		<ta:button id="printBtn" icon="icon-save" key="打印确认" display="false" asToolBarItem="true" disabled="true"/>
...
<script type="text/javascript">
	...
	function transProcess(){
		Base.submit("form1", "intermitTreatmentCheck2Action!transProcess.do");
	}
</script>
