...
// 		fnSetRedBorder();
	...
	function toSave(){
		...
		if(aae140!=""){
			if(aae140=='110'){
				Base.submit("form1","renewalTerminate110Check2Action!toSave.do");
			}else if(aae140=='120'){
				Base.submit("form1","renewalTerminate120Check2Action!toSave.do");
			}else if(aae140=='410'){
				Base.submit("form1","renewalTerminate410Check2Action!toSave.do");
