...
<head>
<title>TreatmentTerminateCheck1</title>
		...
		<ta:panel key="待遇终止信息" id="dyzzxx" cols="3">
  		...
  		<ta:panel id="paymentInfo" key="" >
				...
				<ta:panel id="dbxx" key="代办人信息" cols="3">
				   <ta:text id="aac042" key="代办人姓名"  labelWidth="130" readOnly="true" />
				   <ta:text id="aac044" key="代办人证件号码"  labelWidth="130" readOnly="true" />
				   <ta:selectInput id="aae144" key="代办人姓名" collection="AAE144" labelWidth="130" readOnly="true" />
				   <ta:text id="aac045" key="代办人电话"  labelWidth="130" readOnly="true" />
				</ta:panel>				
			</ta:panel>
  		<ta:tabs height="230">
...
<script type="text/javascript">
	...
	//流程流转
	function submitData(){
		Base.submit("form1", "treatmentTerminateCheck1Action!toSave.do");
