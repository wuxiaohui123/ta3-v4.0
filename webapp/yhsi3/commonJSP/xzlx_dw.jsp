...
<script type="text/javascript">
	...
	function getAllStatus() {
		var aae140Array = [ '110', '120', '210', '310', '311', '320', '330', '340', '370', '410', '510' ];
		var aae140Vals;
	...
	function checkedAae140All() {
		...
		Base.submit("xzlx", myPath() + "/process/publicBusiness/comm/publicBusinessAction!checkbox_aae140_all_dw.do", {
			"dto['flag']" : flag,
			"dto['aae140Vals']" : aae140Vals
		});
	}
	// 选择单一险种
	function checkedAae140(id) {
		...
		Base.submit("xzlx", myPath() + "/process/publicBusiness/comm/publicBusinessAction!checkbox_aae140_dw.do", {
			"dto['aae140']" : id,
			"dto['flag']" : flag,
			"dto['aae140Vals']" : aae140Vals
		});
