...
<body class="no-scrollbar">
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="jbxxfset" key="基本信息" cols="3">
			...
			<ta:selectInput id="ykc005" key="在编标识" collection="SFBZ" labelWidth="130" required="true" readOnly="false" />
		...
		<ta:panel id="sydjxx" key="生育登记信息" cols="3">
			...
			<ta:date id="amc020" key="生育日期" validNowTime="left" required="true" showSelectPanel="true" labelWidth="130" />
			...
			<ta:number id="amc028" key="胎儿数" required="false" labelWidth="130" />
			<ta:number id="amc031" key="胎次" required="false" labelWidth="130" />
...
<script type="text/javascript">
	...
	function fn_ab01Info() {
		if (g_Suggest != "") {
			...
			Base.submit("aab001", "maternityAfter_SpecialAction!queryUnitInfo.do");
		}
	}
	...
	function fn_queryInfo() {
		if (g_Suggest != "") {
			...
			Base.submit("jbxxfset", "maternityAfter_SpecialAction!queryPersonInfo.do", null, null, false, fn_check());
		}
	}
	function fn_check() {
	...
	function fnDelRow(data, e) {
		...
		Base.confirm("确认要删除?", function(btn, callback, options) {
			if (btn) {
				Base.submit("jbxxfset,procInc", "maternityAfter_SpecialAction!toSave.do", {
					"dto['amc238']" : amc238,
					"dto['yae587']" : "3"
				}, null, null, null);
			}
	...
	function submitData() {
		...
		Base.submit("form1", "maternityAfter_SpecialAction!toSave.do", null, null, null, function() {
		});
	}
