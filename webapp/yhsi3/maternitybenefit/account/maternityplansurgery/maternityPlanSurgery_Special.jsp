...
<body class="no-scrollbar">
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="sydjxx" key="手术登记信息" hasBorder="false" cols="3">
			...
			<ta:date id="amc020" key="手术日期" validNowTime="left" required="true" showSelectPanel="true" onChange="yhjb_syjztimepd()" labelWidth="130" />
...
<script type="text/javascript">
	...
	function fn_queryInfo() { //fn_queryInfo是回调函数里面写自己的查询(根据取得的aac001来查询)
		if (g_Suggest != "") {
			...
			Base.submit("jbxxfset", "maternityPlanSurgery_SpecialAction!queryPersonInfo.do", null, null, false, null);
		}
	}
	...
	function fn_ab01Info() { //fn_queryInfo是回调函数里面写自己的查询(根据取得的aac001来查询)
		if (g_Suggest != "") {
			...
			Base.submit("aab001", "maternityPlanSurgery_SpecialAction!queryUnitInfo.do");
		}
	}
	...
	function submitData() {
		...
		Base.submit("form1", "maternityPlanSurgery_SpecialAction!toSave.do");
	}
	...
	function fnDelRow(data,e){
		...
		if (btn) {	
			Base.submit("jbxxfset,procInc", "maternityPlanSurgery_SpecialAction!toSave.do",{"dto['amc238']":amc238,"dto['yae587']":"3","dto['ymc035']":ymc035},null,null,null);
			}
		});
	}
