...
<body style="margin:0px;padding:0px">
	...
	<ta:form id="form1" fit="true" cssStyle="overflow:auto;">
		<ta:panel id="jstj" key="检索条件" cols="3">
			...
			<ta:selectInput id="amc026" key="生育类别" collection="AMC026" labelWidth="130" />
			<ta:date id="amc020" key="生育日期" validNowTime="left" showSelectPanel="true" />
		...
		<ta:panel id="mc01Panel" key="生育登记基本信息" fit="true">
			<ta:datagrid id="mc01Grid" fit="true" columnFilter="true" haveSn="true">
				...
				<ta:datagridItem key="生育类别" id="amc026" collection="AMC026" align="center" dataAlign="center" width="100" />
				<ta:datagridItem key="申请日期" id="aae127" align="center" dataAlign="center" hiddenColumn="true" />
				<ta:datagridItem key="生育日期" width="100" id="amc020" align="center" dataAlign="center" />
				...
				<ta:datagridItem key="生育津贴金" id="amc030" align="center" dataAlign="center" totals="sum" />
				...
				<ta:datagridItem key="新农合已支付医疗费" id="yae150" width="150" align="center" dataAlign="center" totals="sum" />
				...
				<ta:datagridItem key="胎儿数" id="amc028" align="center" dataAlign="center" hiddenColumn="true" />
				<ta:datagridItem key="胎次" id="amc031" align="center" dataAlign="center" hiddenColumn="true" />
				<ta:datagridItem key="生育证号" id="amc021" showDetailed="true" align="center" dataAlign="center" hiddenColumn="true" />
				<ta:datagridItem key="出生证号" id="amc022" showDetailed="true" align="center" dataAlign="center" hiddenColumn="true" />
				<ta:datagridItem key="联系电话" id="aae005" showDetailed="true" align="center" dataAlign="center" hiddenColumn="true" />
...
<script type="text/javascript">
	...
	function query() {
		Base.submit("form1", "mateRegistrationInfoQueryAction!query.do");
	}
