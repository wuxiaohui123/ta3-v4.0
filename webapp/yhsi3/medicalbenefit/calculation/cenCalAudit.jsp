...
<body class="no-scrollbar">
	...
	<ta:toolbar id="ButtonLayout1">
		...
		<ta:button id="btnSave" icon="xui-icon-spotSave" key="复核[S]" hotKey="S" onClick="toSave()" asToolBarItem="true" />
...
<script type="text/javascript">
	...
	function clickfn(e,rowdata){
		...
		Base.openWindow('userwin',"明细","<%=path%>/medicalbenefit/calculation/cenCalAuditAction!toDetail.do",param,900,500,null,null,true);
	}
	...
	function toSave()
	{
		...
		Base.submit("panel2","cenCalAuditAction!toSave.do",prm,null,null,function(){
	...
	function toQuery()
	{
		...
		Base.submit("panel1","cenCalAuditAction!toQuery.do");
	}
