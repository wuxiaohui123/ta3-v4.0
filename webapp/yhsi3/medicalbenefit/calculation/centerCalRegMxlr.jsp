...
<body class="no-scrollbar">
	...
	<ta:form id="form1" fit="true">
	   ...
	   <%@ include file="/yhsi3/medicalbenefit/common/kc22Lr.jsp"%>
	</ta:form>
...
<script type="text/javascript">
	...
	function toPrint()
	{
		...
		var reportName="CenterJS_SHD.raq"; // 住院审核单
		if("11" == aka130 || "12" == aka130 || "14"==aka130 || "15" == aka130)
			reportName = "centerBxMxsh_MZ.raq"; // 门诊审核单
		if("16" == aka130)
			reportName = "centerBxMxsh_sy.raq";
