...
<body class="no-scrollbar">
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="panel1" key="基本信息" cols="3">
			...
			<ta:text id="aac008" key="参保状态" readOnly="true" labelWidth="120" />
...
<script type="text/javascript">
	...
	function fnZY()
	{
		...
		{
			Base.submit("aac001,aka130","centerCalRegLxAction!getKc20.do",null,null,false,function(){
				Base.hideObj("akb020");
	...
	function getYdaz()
	{
		...
		if("28"== aka130 || "29" == aka130)
		{
			...
			if("" == aac001 || null == aac001)
				return;
			Base.submit("aac001","centerCalRegLxAction!getKc45k1.do",null,null,false,function(){
				Base.hideObj("akb020");
				Base.showObj("akb020_y");
				Base.setEnable("akb020_y");
				Base.setValue("akb020_y",""); // 清空异地医院编码
	...
	function fnAkb020_y(key,value)
	{
		...
		if("22" == aka130 || "24" == aka130 || "26" == aka130 || "26a" == aka130) // 区内转院和区外转院
		{
			...
			Base.submit("","centerCalRegLxAction!getKc20Detail.do",param);
		}
	}
	...
	function toSave() 
	{
			...
			if("" == akb020 || null == akb020)
				return Base.alert("请输入医疗机构编号或选择申请备案医院!","warn",function(){Base.focus("akb020");});
