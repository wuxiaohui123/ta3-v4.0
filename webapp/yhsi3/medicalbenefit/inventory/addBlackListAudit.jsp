	...
	<body class="no-scrollbar">
		...
		<ta:form id="form1" fit="true">			
			...
			<ta:panel id="panel1" key="黑名单新增" cols="3">
				<ta:selectInput id="aaa028" key="当事人类别" collection="AAA028" labelWidth="120" required="true" filter="1,2" reverseFilter="true"/> 
				<ta:text id="aac001" key="个人ID" required="true" maxLength="20" labelWidth="120"/>
