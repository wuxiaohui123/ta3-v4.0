...
<script type="text/javascript">
	...
	function toQuery(){
		...
		Base.submit('akb020','hosDrugsDeleteAuditAction!toQuery.do');
	}
	
	//双击查看详细三目对码信息
	function getDetailInfo(e,rowdata){
		Base.openWindow("userwin", "本次申请包含的三目对码信息", "hosDrugsDeleteAuditAction!toKe19Info.do",
	...
	function toSave() {
		...
		if (Base.validateForm("form1")) {
			Base.confirm("确定要提交吗?", function(btn, callback) {
				if (btn) {
					Base.submit("form1,dgSmdm","hosDrugsDeleteAuditAction!toSave.do"); 
				}
			});
		}
	}
