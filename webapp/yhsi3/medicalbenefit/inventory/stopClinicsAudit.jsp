...
<body class="yes-scrollbar" >
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel  id="fdtBaseinfo" key="社保中心目录基本信息" cols="3" >
				...
				<ta:selectInput id="aka031" key="收费项目等级"  collection="AKA065"  labelWidth="150" readOnly="true"/>
				...
				<ta:date id="aae030" key="开始生效日期" showSelectPanel="true" labelWidth="150"  readOnly="true" />
				...
				<ta:selectInput id="aja006" key="失业使用标志" collection="AJA006" display="false" labelWidth="150"  readOnly="true" display="false"/>
...
<script type="text/javascript">
	...
	function fn_callback() {
		...
		Base.submit("", "stopClinicsAuditAction!toClinicsInfo.do", {"dto['aaz231']" : g_Suggest[0]}, null, false, null, null);
	}
	
	//查询数据库
	function query(){
		Base.submit("aaz231","stopClinicsAuditAction!query.do");
	}
	...
	function toSave() {
		...
		if (Base.validateForm("form1")) {
			Base.confirm("确定要提交吗?", function(btn, callback) {
				if (btn) {
					Base.submit('form1','stopClinicsAuditAction!toSave.do');
				}
			});
		}
