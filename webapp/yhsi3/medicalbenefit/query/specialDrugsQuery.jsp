...
<body class="yes-scrollbar">
	...
	<ta:form id="form1" fit="true">
	     <ta:panel id="fltQuery" key="查询条件" cols="3">
	         ...
	         <ta:box cols="2">
				<ta:text id="akb020" key="医疗机构编码" labelWidth="150" onChange="getKb01Info()" columnWidth="0.9" />
				<ta:buttonLayout columnWidth="0.1" cssStyle="margin-left:-15px">
	         ...
	         <ta:text id="aaz231" key="社保三大目录ID" labelWidth="150" onChange="sfwQueryUtil(3,'getKa20Filter',Base.getValue('aaz231')+',0')" />
	         <ta:text id="ake001" key="社保三大目录统一编码" labelWidth="150" readOnly="true" />
	         <ta:text id="ake002" key="社保三大目录名称" labelWidth="150" readOnly="true"/>	         
	     </ta:panel>
		 <ta:panel id="pnlSpecialDrugs" key="特殊用药申请查询"  fit="true" expanded="false"  scalable="false">
		     <ta:datagrid id="dgDrugs"  fit="true"  haveSn="true"  snWidth="35" >
			     ...
			     <ta:datagridItem id="akb022" align="center" key="医疗服务机构类型" maxChart="8"  sortable="true"/>
			     ...
			     <ta:datagridItem id="aaa027" align="center" key="统筹区编码" maxChart="6" showDetailed="true" dataAlign="left"/>
				 <ta:datagridItem id="akc030" align="center" key="申请原因"  maxChart="30" showDetailed="true" dataAlign="left"  />
				 <ta:datagridItem id="aka067" align="center" key="药品剂量单位"   maxChart="6" showDetailed="true" dataAlign="left"  />
				 <ta:datagridItem id="aaz231" align="center" key="社保三大目录ID"   showDetailed="true" dataAlign="left"  maxChart="8"  />
				 <ta:datagridItem id="ake001" align="center" key="社保三大目录统一编码"   showDetailed="true" dataAlign="left"  maxChart="6"  />
				 <ta:datagridItem id="ake002" align="center" key="社保三大目录名称"   showDetailed="true" dataAlign="left"  maxChart="8"  />
				 <ta:datagridItem id="akc226" align="center" key="数量"   showDetailed="true" dataAlign="left"  maxChart="4"  />
				 <ta:datagridItem id="aae100" align="center" key="当前有效标志"   showDetailed="true" dataAlign="left"  maxChart="2" collection="AAE100"  />
				 <ta:datagridItem id="aaz002" align="center" key="业务日志ID"    showDetailed="true" dataAlign="left"  maxChart="10" />
				 <ta:datagridItem id="ykh302" align="center" key="YKH302医生名称"    showDetailed="true" dataAlign="left"  maxChart="6" hiddenColumn="true"/>
			     ...
			     <ta:datagridItem id="aae016" align="center" key="复核标志"   showDetailed="true" dataAlign="center"  maxChart="4"  />
			     ...
			     <ta:datagridItem id="yab003" align="center" key="复核经办机构"   showDetailed="true" dataAlign="center"  maxChart="6"  />
			</ta:datagrid>
		  </ta:panel>
	</ta:form>
</body>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		initializeSuggestFramework(3,"", "aaz231", 500, 300, 4, fn_getDrug, 0, false);
	});
	
	//RPC回调函数,获取社保三大目录药品信息
   function fn_getDrug(){
	   Base.setValue("ake001","");
	   Base.setValue("ake002","");
       Base.setValue("aka061","");
	   Base.setValue("aka036","");
	   Base.setValue("aka064","");
	   Base.setValue("aae100","");
	   if(g_Suggest[3]!= "药品"){
	   ...
	   Base.submit("","specialDrugsAppQueryAction!toDrugInfo.do",{"dto['aaz231']": g_Suggest[0]},false,null,null);
     }
	...
	function toQuery(){
	     ...
	     Base.submit("fltQuery","specialDrugsAppQueryAction!toQuery.do");	
	}
