...
<%@ include file="/ta/inc.jsp"%>
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="pnlCxtj" key="查询条件" cols="7" >
		    <ta:text id="yka316_yw" key="清算类别(业务)" display="false"/>
			...
			<ta:selectInput id="yka316" key="人员类别" span="2" collection="YKA316" filter="10,11" reverseFilter="true"/>
		</ta:panel>
...
<script type="text/javascript">
	...
	function query()
	{
		...
		Base.submit('pnlCxtj','detailReviewAction!toQueryHospitalInfo.do',null,null,false,null,function(){
			Base.alert("没有查询到数据!", "warn");
		});
	}
	...
	function toSave()
	{
		...
		top._mzydsh_aaz272 = "";
		Base.openWindow('w_sh',"医疗机构费用月度审核","<%=path%>/process/medicalbenefit/reckoning/detailReviewAction!toOpenSh.do", parameter, "80%", "80%",null,function(){
			var aaz272 = top._mzydsh_aaz272;
			if("" == aaz272 || null == aaz272){
				
			}else{
			    Base.submit("","detailReviewAction!toQueryHospitalInfo.do",{"dto.aaz272":aaz272});
			}
		},true);
	}
	...
	function toCancel()
	{
		...
		if("" == dgrdJSLX || null == dgrdJSLX){
			...
			Base.submit("","detailReviewAction!toCancel.do",parameter,null,false,function(){
	...
	function toSet(){
	   if(null == columnData || "" == columnData){
	    ...
	    openGridSet("dgrdJSLX",columnData,"menuid01031611",null,null,null);
	}
	var columnData = null;
</script>
