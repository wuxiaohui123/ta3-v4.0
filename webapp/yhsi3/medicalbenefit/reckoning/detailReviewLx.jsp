...
<%@ include file="/ta/inc.jsp"%>
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="pnlCxtj" key="查询条件" cols="7" >
			...
			<ta:selectInput id="yka316" key="人员类别" span="2" collection="YKA316" filter="17,18,24" reverseFilter="true"/>
		</ta:panel>
...
<script type="text/javascript">
	...
	function query()
	{
		...
		Base.submit('pnlCxtj','detailReviewLxAction!toQueryHospitalInfo.do');
	}
	...
	function toSave()
	{
		...
		parent.Base.openWindow('w_sh',"医疗机构费用月度审核","<%=path%>/process/medicalbenefit/reckoning/detailReviewLxAction!toOpenSh.do", parameter, "80%", "80%",null,null,true);
	}
	...
	function toCancel()
	{
		...
		if("" == dgrdJSLX || null == dgrdJSLX){
			...
			Base.submit("","detailReviewLxAction!toCancel.do",parameter,null,false,function(){
	...
	function toSet(){
	   if(null == columnData || "" == columnData){
	    ...
	    openGridSet("dgrdJSLX",columnData,"menuid01031612",null,null,null);
	}
	var columnData = null;
</script>
