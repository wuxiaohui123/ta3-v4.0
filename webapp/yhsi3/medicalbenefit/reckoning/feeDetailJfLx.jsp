...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	...
	<body class="no-scrollbar" >
		<ta:pageloading/>
		<ta:toolbar id="btr1">
		    <ta:toolbarItem id="btnQuery"  key="查询"      icon="xui-icon-query"      onClick="toQuery()"/>
			<ta:toolbarItem id="btnJf"     key="拒付"      icon="xui-icon-spotSave"   onClick="toJf('1')"/>
			<ta:toolbarItem id="btnQxJf"   key="取消拒付"  icon="xui-icon-spotEdit"   onClick="toJf('0')"/>
		    <ta:toolbarItem id="btnClear"  key="清条件"    icon="xui-icon-query"      onClick="toClearTj()" />
			<ta:toolbarItem id="btnReset1" key="退出"      icon="xui-icon-spotClose"  onClick="parent.Base.closeWindow('w_jf')"/>
		</ta:toolbar>
		<ta:form id="form" fit="true" >
			...
			<ta:box id="bxCxtj" cols="5">
			    ...
			    <ta:box cols="2" span="2">
				    <ta:number       id="akc225_s" key="价格范围"  labelWidth="80" columnWidth="0.6"/>
				    <ta:number       id="akc225_e" key="至"  labelWidth="15"  columnWidth="0.4"/>
				</ta:box>   
			    ...
			    <ta:date id="ake007"  key="处方日期" labelWidth="80" showSelectPanel="true"/>
			    <ta:text id="ake001"  key="项目编码" labelWidth="80"/>
				<ta:text id="ake002"  key="项目名称" labelWidth="80"/>
			</ta:box>
			<ta:box id="bxHz"  layout="border" layoutCfg="{leftWidth:450,bottomHeight:300,noLeftCenterBorder:false}">
			<ta:panel id="pnlHz" key="汇总数据" expanded="false"  fit="true" position="left">
			   <ta:datagrid id="dgHz" fit="true" forceFitColumns="true" onRowClick="fnDbClick" >
			      ...
			      <ta:datagridItem id="aka069" key="先自付比例" align="center" showDetailed="true" dataAlign="right" totals="sum" tatalsTextShow="false" totalsAlign="right" maxChart="5"/>
			      ...
			      <ta:datagridItem id="yka318" key="比例先自付" align="center" showDetailed="true" dataAlign="right" totals="sum" tatalsTextShow="false" totalsAlign="right" maxChart="5"/>
			      <ta:datagridItem id="yka319" key="符合范围 " align="center" showDetailed="true" dataAlign="right" totals="sum" tatalsTextShow="false" totalsAlign="right" maxChart="5"/>
			   </ta:datagrid>
			</ta:panel>
			<ta:panel id="pnlMx" key="详细信息" expanded="false" fit="true" position="center" >
			   <ta:datagrid id="dgMx" fit="true" forceFitColumns="true" selectType="checkbox" >
					...
					<ta:datagridItem id="aka069" key="先自付比例"  align="center" showDetailed="true" dataAlign="right"  maxChart="5"   dataType="number" sortable="true"/>
					...
					<ta:datagridItem id="akc268" key="超限价"  align="center" showDetailed="true" dataAlign="right"  maxChart="6" dataType="number" totals="sum" tatalsTextShow="false"/>
					<ta:datagridItem id="yka318" key="比例先自付"  align="center" showDetailed="true" dataAlign="right"  maxChart="6" dataType="number" totals="sum" tatalsTextShow="false"/>
					...
					<ta:datagridItem id="aka070" key="剂型"  align="center" showDetailed="true" dataAlign="left"  maxChart="6" />
...
function toJf(lx)
{
	...
	var data1 = [];
	var rowdata1 = {};
	$.each(gridData,function(indext,rowdata){
		rowdata1 = {};
		rowdata1.aaz213 = rowdata.aaz213;//人员医疗费用明细ID
		rowdata1.akc265 = rowdata.yka319;//拒付金额
		data1.push(rowdata1);
	});
	var parameter={};
	parameter["gridData"]=Ta.util.obj2string(data1);
	parameter["dto.yke091"]=lx;
	Base.submit("bxID","detailAuditLXAction!toSaveJf.do",parameter,null,false,null,null);
}
...
function getCxtj()
{
	...
	parameter["dto['ake007']"]=Base.getValue("ake007");
...
function toQuery()
{
	var parameter=getCxtj();
	Base.clearGridData("dgMx");	
	Base.clearGridData("dgHz");	
	Base.submit("","<%=path %>/process/medicalbenefit/reckoning/detailAuditLXAction!toQueryShMx.do",parameter,null,false,null,null);
}
...
function fnDbClick(e,rowdata)
{
	...
	Base.submit("","<%=path %>/process/medicalbenefit/reckoning/detailAuditLXAction!toQueryKc22.do",parameter,null,false,null,null);
}
