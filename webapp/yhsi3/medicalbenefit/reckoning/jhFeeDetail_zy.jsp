...
<html xmlns="http://www.w3.org/1999/xhtml"> 
	...
	<body class="no-scrollbar" >
		...
		<ta:toolbarItem id="hzQueryBtn" key="汇总清单" icon="xui-icon-print"   onClick="fnPrint()"  />
		<ta:toolbarItem id="clearBtn" key="清条件" icon="xui-icon-delete"   onClick="toClearTj()"  />
		<ta:toolbarItem id="closeBtn" key="关闭" icon="xui-icon-spotClose"   onClick="parent.Base.closeWindow('detailWin')"  />
	    </ta:toolbar>
		<ta:form id="form" fit="true" >
		   <ta:box id="bxID" cols="3" >
				...
				<ta:text id="aae011" key="制表人" readOnly="true" display="false" />
				<ta:text id="aae036" key="制表日期" readOnly="true" display="false" />
...
function fnPrint(){
    ...
    var aae036 = Base.getValue("aae036");
	$("#report1_printIFrame").attr("src","<%=path%>/reportServlet?action=2&name=report1&reportFileName=ybxmmxPrint.raq&"+
