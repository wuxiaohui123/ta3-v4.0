	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="fltCxtj" key="查询条件" cols="5" >
			...
			<ta:box span="2" cols="3">
			    <input   id="aae036_check" type="checkbox" style="width:20px;padding:0px;margin-top:5px;margin-left:4%;" />
			...
			<ta:selectInput id="aka120"  key="病种名称"  labelWidth="90"  span="2"  maxVisibleRows="10"/>
			<ta:text id="akc191"  key="流水号" labelWidth="90"/>
			<ta:box span="2" cols="3">
			  <input   id="aae031_check" type="checkbox" style="width:20px;padding:0px;margin-top:5px;margin-left:5%;" />
			  <ta:date id="aae031_s" key="就诊日期"  showSelectPanel="true" labelWidth="70"  cssStyle="margin-left:-80%;margin-right:40px;"/>
			  <ta:date id="aae031_e" key="至"  showSelectPanel="true" labelWidth="15" cssStyle="margin-left:-40px;"/>
			</ta:box>
			<ta:selectInput id="yka095" key="审核病种类型" collection="AKA122" labelWidth="90" />
			...
			<ta:datagrid id="dgRYJS" fit="true"  forceFitColumns="true" haveSn="true" > 
			   ...
			   <ta:datagridItem id="yke090" key="审核标记"  align="center" dataAlign="left" maxChart="4" collection="YKE090"  formatter="fnFormatter"  sortable="true"/>
                <ta:datagridItem id="aac001" key="保险号"  align="center"   dataAlign="left" showDetailed="true" maxChart="8" formatter="fnFormatter"  sortable="true"/>
				 ...
				 <ta:datagridItem id="akc264" key="总费用"  align="center" dataAlign="right"  showDetailed="true"  maxChart="6" formatter="fnFormatter"  sortable="true"  totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="yka318" key="先比例自付"  align="center" dataAlign="right"  showDetailed="true"  maxChart="6" formatter="fnFormatter" sortable="true"  totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="akc228" key="自费费用"  align="center" dataAlign="right"  showDetailed="true"  maxChart="6" formatter="fnFormatter" sortable="true"  totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="akc268" key="超限额自费"  align="center" dataAlign="right"  showDetailed="true"  maxChart="6" formatter="fnFormatter"  sortable="true" totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="yka319" key="医保范围内费用"  align="center" dataAlign="right"  showDetailed="true"  maxChart="7" formatter="fnFormatter"  sortable="true"  totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="akb069" key="拒付金额"  align="center" dataAlign="right"  showDetailed="true"  maxChart="6" formatter="fnFormatter" sortable="true" totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="ake034" key="个人账户支付"  align="center" dataAlign="right"  showDetailed="true"  maxChart="6" formatter="fnFormatter"  sortable="true" totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="yka115" key="起付线"  align="center" dataAlign="right"  showDetailed="true"  maxChart="4" formatter="fnFormatter" sortable="true"/>
				 <ta:datagridItem id="yka059" key="统筹内个人支付"  align="center" dataAlign="right"  showDetailed="true"  maxChart="7" formatter="fnFormatter"  sortable="true" totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="tczf" key="统筹支付"  align="center" dataAlign="right"  showDetailed="true"  maxChart="9" formatter="fnFormatter"  sortable="true"  totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="yka063" key="本次超封顶线金额"  align="center" dataAlign="right"  showDetailed="true"  maxChart="9" formatter="fnFormatter"  sortable="true" totals="sum" tatalsTextShow="false" totalsAlign="right"/>
				 <ta:datagridItem id="ake053" key="年度医保支付范围内累计"  align="center" dataAlign="right"  showDetailed="true"  maxChart="12" formatter="fnFormatter" sortable="true" totals="sum" tatalsTextShow="false" totalsAlign="right"/>
...
<script type="text/javascript">
	...
	function query()
	{
		...
		// 查询字段
		var ids =  "akb020,yka316,aac001,aac003,akc191,aka120,aac008,yka095,aka123,yke090";
	   ...
	   // 检查审核日期是否被勾选,如果选中,则作为查询条件
		...
		// 查询结算数据
		Base.submit(ids,"detailAuditMxbAction!query.do",null,null,false,function(data){
	...
	function toTg(lx)
	{
		...
		Base.submit("akb020","detailAuditMxbAction!toSaveJH.do",parameter,false,null,null);
	}
	...
	function toQueryDetail()
	{
		...
		parent.Base.openWindow('detailWin',"明细信息","<%=path%>/process/medicalbenefit/reckoning/detailAuditMxbAction!checkDetail.do", parameter, "98%", "98%",null,function(){
		},true);
	}
	...
	function toShMx()
	{
		...
		parameter["dto['aaz216']"]=gridSelected[0].aaz216;
		parameter["dto['aaz208']"]=gridSelected[0].aaz208;
		parent.Base.openWindow("w_sh","审核","<%=path%>/process/medicalbenefit/reckoning/detailAuditMxbAction!toOpenSh.do", parameter, "99%", "99%",null,function(){
		},true);
	}
	...
	function toPrint() 
	{
		...
		parent.Base.openWindow("w_jh","稽核打印","<%=path%>/process/medicalbenefit/reckoning/detailAuditMxbAction!toPrint.do", param, "99%", "99%",null,null,true);
	}
	...
	function toOpen(){
		if(null == columnData || "" == columnData){
		   ...
		   openGridSet("dgRYJS",columnData,"menuid01031613",null,null,null);
	}
	var columnData = null;
</script>
