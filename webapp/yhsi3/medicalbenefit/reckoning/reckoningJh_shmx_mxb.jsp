...
function toJf(lx)
{
	...
	Base.submit("bxID","<%=path %>/process/medicalbenefit/reckoning/detailAuditMxbAction!toSaveDetail.do",parameter,null,false,null,null);
}

// 审核
function toSh()
{
	Base.submit("bxID","<%=path %>/process/medicalbenefit/reckoning/detailAuditMxbAction!toSaveShMx.do");
}
// 查询
function toQuery()
{
	...
	Base.submit("","<%=path %>/process/medicalbenefit/reckoning/detailAuditMxbAction!toQueryShMx.do",parameter,null,false,null,null);
}
...
function fnDbClick(e,rowdata)
{
	...
	if(flag)
	   parameter["dto['jf']"]="1";
	Base.submit("","<%=path %>/process/medicalbenefit/reckoning/detailAuditMxbAction!toQueryKc22.do",parameter,null,false,null,null);
}
