...
function toJf(lx)
{
	...
	Base.submit("bxID","<%=path %>/process/medicalbenefit/reckoning/detailAuditMztcAction!toSaveDetail.do",parameter,null,false,null,null);
}

// 审核
function toSh()
{
	Base.submit("bxID","<%=path %>/process/medicalbenefit/reckoning/detailAuditMztcAction!toSaveShMx.do");
}
// 查询
function toQuery()
{
	...
	parameter["dto['aaz216']"]=Base.getValue("aaz216");
	parameter["dto['aaz208']"]=Base.getValue("aaz208");
	...
	Base.submit("","<%=path %>/process/medicalbenefit/reckoning/detailAuditMztcAction!toQueryShMx.do",parameter,null,false,null,null);
}
...
function fnDbClick(e,rowdata)
{
	...
	if(flag)
	   parameter["dto['jf']"]="1";
	Base.submit("","<%=path %>/process/medicalbenefit/reckoning/detailAuditMztcAction!toQueryKc22.do",parameter,null,false,null,null);
}
