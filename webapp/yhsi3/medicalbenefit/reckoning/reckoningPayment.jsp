...
<%@ include file="/ta/inc.jsp"%>
	...
	<body class="no-scrollbar"  >
		...
		<ta:toolbar id="ButtonLayout1">
            ...
            <ta:toolbarItem id="ButtonSave" key="清算支付(S)" icon="xui-icon-edit2" hotKey="S" onClick="save()"  />
            <ta:toolbarItem id="ButtonBack" key="撤销清算支付(C)" icon="xui-icon-edit2" hotKey="C" onClick="saveBack()"  />
	...
	<ta:fieldset key="查询条件" cols="3" id="baseinfo"  >
		...
		<ta:datagrid  id="kf20"   haveSn="true" fit="true" selectType="checkbox" headerColumnsRows="2">
...
$(document).ready(function () {
	...
	function query(){		
		Base.submit("baseinfo","reckoningPaymentAction!query.do",null,null,false,null,null);
		Base.activeTab('tab1');
	}
	function save(){
    	...
    	Base.submit("baseinfo","reckoningPaymentAction!save.do",parameter,null,false,null,null);
    	Base.activeTab('tab2');
    }
	// 渲染行颜色
