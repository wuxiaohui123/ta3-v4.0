...
<script type="text/javascript">
	...
	//查询
	function query(){
		Base.submit('form1','reckoningRollbackYearAction!toQueryHospitalInfo.do');
	}
	//保存
	function toSave(){
		if(Base.validateForm("form1")){
			...
			var gridSelectedzy=Base.getGridSelectedRows("dgrdReckoningInfozy");//选中的表格数据
			...
			Base.confirm("确定要保存吗?",function(yes){
				if(yes){					
					...
					Base.submit("form1","reckoningRollbackYearAction!save.do",parameter,null,false,null,null);
				}
			});
		}else{
