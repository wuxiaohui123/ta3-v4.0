	...
	<body class="no-scrollbar" >
		...
		<ta:form id="form" fit="true" >
		    <ta:box id="bxZ" cols="3">
				...
				<ta:selectInput id="yka316" key="人员类别"  collection="YKA316" required="true" filter="19"  reverseFilter="true" value="19" labelWidth="120"/>
...
function toMxSh()
{
	Base.submit("bxZ","detailReviewMztcAction!toQueryFromKc24.do");
}

function save()
{
	Base.submit("bxZ","detailReviewMztcAction!toSave.do");
}
