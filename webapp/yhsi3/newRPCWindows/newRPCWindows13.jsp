...
<body class="no-scrollbar">
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="p0" key="查询结果" fit="true">
			<ta:datagrid id="dg13" forceFitColumns="true" onRowDBClick="fn_setData" fit="true">
				...
				<ta:datagridItem id="aac006_1" key="年龄" align="center" dataAlign="center" width="8"/>
...
<script type="text/javascript">
	...
	function fn_query(){
		...
		Base.submit("form1", myPath()+"/process/synthesis/suggestFrameworkAction!getAac001DYAC60List.do");
	}
	//关闭前对父界面需要的数据进行设值 
