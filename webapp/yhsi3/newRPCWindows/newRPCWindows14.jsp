...
<body class="no-scrollbar">
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="p0" key="查询结果" fit="true">
			<ta:datagrid id="dg14" forceFitColumns="true" onRowDBClick="fn_setData" fit="true">
				...
				<ta:datagridItem id="AAB001" key="单位编号" align="center" dataAlign="center" showDetailed="true" width="20"/>
				<ta:datagridItem id="AAE044" key="单位名称" align="center" dataAlign="center" width="8"/>
				<ta:datagridItem id="YLB003" key="工程项目名称" align="center" dataAlign="center" width="8"/>
			</ta:datagrid>
		</ta:panel>
	</ta:form>
</body>
...
<script type="text/javascript">
	...
	function fn_query(){
		...
		Base.submit("form1", myPath()+"/process/synthesis/suggestFrameworkAction!getAac001DYList.do");
		<%-- Base.submit("form1,aae140","<%=basePath%>process/synthesis/suggestFrameworkAction!getAc01List.do"); --%>
	}
	//关闭前对父界面需要的数据进行设值 
	function fn_setData(e, rowdata){
		...
		if(!(Base.getValue('aae044') == '')){
			parent.Base.setValue('aae044', rowdata.aae044);	
		}else{
			parent.Base.setValue('aae044', rowdata.YLB003);
		}		
