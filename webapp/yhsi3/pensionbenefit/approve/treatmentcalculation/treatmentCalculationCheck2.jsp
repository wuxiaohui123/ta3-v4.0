...
<head>
<title>TreatmentCalculationCheck2</title>
		...
		<ta:tabs fit="true">
			<ta:tab id="txxx" key="退休信息" cssStyle="overflow:auto;" selected="true">
				...
				<ta:panel id="rytxxx" cols="3" key="人员退休信息">
					...
					<ta:number id="yic206" key="提前退休月数" labelWidth="130" readOnly="true" max="999" min="0" alignLeft="true" />
			...
			<ta:tab id="rynjfzsxxL" key="101号文人员年缴费指数信息(老办法)" cssStyle="overflow:hidden;">
				<ta:datagrid id="rynzsxxGridL" haveSn="true" fit="true" height="300" columnFilter="true">
					<ta:datagridItem id="yic066" key="计算办法" width="260" collection="yic066" sortable="true" align="center" dataAlign="center" />
					<ta:datagridItem id="aae001" key="年度" width="150" sortable="true" align="center" dataAlign="center" />
...
<script type="text/javascript">
	...
	//保存经办信息
	function submitData() {
		Base.submit("form1", "treatmentCalculationCheck2Action!toSave.do", null, null, null, function(data) {
