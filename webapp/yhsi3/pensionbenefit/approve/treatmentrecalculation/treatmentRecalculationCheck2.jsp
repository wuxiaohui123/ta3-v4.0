...
<head>
<title>TreatmentRecalculationCheck2</title>
		...
		<ta:tabs height="650" fit="true">
			<ta:tab id="txxx" key="退休信息" cssStyle="overflow:auto;" selected="true">
				...
				<ta:panel id="rytxxx" cols="3" key="人员退休信息">
					...
					<ta:selectInput id="yae230" key="是否补发待遇" labelWidth="130" collection="yae230" readOnly="true" />
...
<script type="text/javascript">
	...
	//保存经办信息
	function submitData() {
		Base.submit("form1", "treatmentRecalculationCheck2Action!toSave.do", null, null, null, function(data) {
			null;
		});
	}
</script>
