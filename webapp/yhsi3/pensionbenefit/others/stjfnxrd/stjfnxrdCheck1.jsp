...
<body class="no-scrollbar">
	...
	<ta:form id="form1" fit="true">
		...
		<ta:panel id="rdxx" cols="1" key="视同缴费信息" height="200">
			<ta:datagrid id="dg_rdxx" haveSn="true" fit="true" forceFitColumns="true">
				<ta:datagridItem id="aaz185" key="人员工作经历ID" align="center" dataAlign="center" hiddenColumn="false" />
				<ta:datagridItem id="aae041" key="开始年月" align="center" dataAlign="center" width="200" />
				<ta:datagridItem id="aae042" key="终止年月" align="center" dataAlign="center" width="200" />
				<ta:datagridItem id="yae599" key="月数" align="center" dataAlign="center" width="100" />
				<ta:datagridItem id="aab004" key="单位名称" align="center" dataAlign="left" width="700" />
			</ta:datagrid>
		</ta:panel>
	</ta:form>
</body>
...
<script type="text/javascript">
	...
	function submitData() {
		Base.submit("form1", "stjfnxrdCheck1Action!toSave.do", null, null, null, null);
	}
</script>
