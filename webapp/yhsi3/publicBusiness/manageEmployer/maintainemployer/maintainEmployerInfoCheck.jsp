...
<html>
<head>
<title>maintainEmployerInfoCheck</title>
<%@ include file="/ta/inc.jsp"%>
</head>
<body>
	<ta:pageloading />
	<ta:toolbar id="toolbarUnit">
		<ta:toolbarItem id="btnSave" key="保存[S]" hotKey="alt+S" icon="xui-icon-spotSave" onClick="submitData();" />
	...
	<ta:form id="form1" fit="true">
		<ta:panel key="审核信息" height="85">
			...
			<ta:text id="aaa121" key="业务日志ID" display="false" />
		</ta:panel>
		...
		<ta:panel fit="true" hasBorder="false">
			...
			<ta:tabs id="tbsSI" fit="true" onSelect="fnSelect">
				<ta:tab id="tbRegistSI" key="单位基本信息" cssStyle="overflow:auto">
					...
					<ta:panel id="fld_dwxx" key="单位信息" cols="3">
						...
						<ta:text id="aae044" key="单位名称" labelWidth="125" span="2" maxLength="100" required="true" readOnly="true" />
						<ta:text id="aab999" key="单位管理码" labelWidth="125" maxLength="20" readOnly="true" />
						<ta:text id="yab559" key="单位档案编号" labelWidth="125" maxLength="20" readOnly="true" />
						<ta:selectInput id="aab065" key="特殊单位类别" labelWidth="125" required="true" collection="AAB065" readOnly="true" />
						<ta:selectInput id="aaa149" key="行业风险类别" labelWidth="125" required="true" collection="AAA149" readOnly="true" />
						<ta:selectInput id="aab022" key="行业代码" labelWidth="125" required="true" collection="AAB022" readOnly="true" />
						<ta:selectInput id="aab019" key="单位类型" labelWidth="125" required="true" collection="AAB019" readOnly="true" />
						<ta:selectInput id="aab021" key="隶属关系" labelWidth="125" required="true" collection="AAB021" readOnly="true" />
						<ta:selectInput id="aab020" key="经济类型" labelWidth="125" required="true" collection="AAB020" readOnly="true" />
						<ta:selectInput id="aab301" key="所属行政区代码" labelWidth="125" collection="AAB301" readOnly="true" />
						<ta:selectInput id="yab243" key="单位所在地" labelWidth="125" display="true" collection="AAB301" readOnly="true" />
						<ta:text id="aae045" key="法人代表姓名" required="true" maxLength="50" labelWidth="125" readOnly="true" />
						<ta:text id="aae046" key="法人公民身份证号码" validType="idcard" maxLength="18" labelWidth="125" readOnly="true" />
						<ta:text id="aae013_unit" key="备注" labelWidth="125" span="3" maxLength="200" readOnly="true" />
					</ta:panel>
					<ta:panel id="fld_gsxx" key="成立信息" cols="3">
						<ta:text id="aae053" key="组织机构代码" labelWidth="125" bpopTipPosition="bottom" maxLength="10" required="true" bpopTipMsg="10位字符,只能是'-'或数字并且倒数第二位为'-'" readOnly="true" />
						<ta:text id="aab023" key="主管部门" labelWidth="125" maxLength="100" readOnly="true" />
						<ta:date id="aae047" key="成立日期" showSelectPanel="true" labelWidth="125" readOnly="true" />
						<ta:text id="aae048" key="批准成立部门" maxLength="100" labelWidth="125" readOnly="true" />
						<ta:date id="aae049" key="批准成立日期" showSelectPanel="true" labelWidth="125" readOnly="true" />
						<ta:text id="aae051" key="批准成立文号" labelWidth="125" maxLength="100" readOnly="true" />
					</ta:panel>
					<ta:panel id="fld_swxx" key="联系信息" cols="3">
						<ta:text id="aae006" key="地址" labelWidth="125" maxLength="200" required="true" span="2" readOnly="true" />
						<ta:text id="aae007" key="邮政编码" labelWidth="125" validType="zipcode" required="true" maxLength="6" readOnly="true" />
						<ta:text id="aae004" key="联系人姓名" labelWidth="125" maxLength="60" required="true" readOnly="true" />
						<ta:text id="aae005" key="联系电话" labelWidth="125" required="true" validType="mobile" maxLength="20" readOnly="true" />
						<ta:text id="aae159" key="联系电子邮箱" labelWidth="125" validType="email" maxLength="50" readOnly="true" />
					</ta:panel>
					<ta:panel id="fld_dwzg" key="专管员信息" cols="3">
						<ta:text id="aab016" key="专管员姓名" labelWidth="125" maxLength="60" required="true" readOnly="true" />
						<ta:text id="aab018" key="专管员联系电话" labelWidth="125" validType="mobile" maxLength="20" required="true" readOnly="true" />
						<ta:text id="yab237" key="专管员所在部门" labelWidth="125" maxLength="100" readOnly="true" />
					</ta:panel>
					<ta:panel id="fld_gsdzxx" key="工商登记信息" cols="3">
						<ta:text id="aab007" key="登记执照号码" labelWidth="125" maxLength="50" readOnly="true" />
						<ta:date id="aab008" key="登记发照日期" labelWidth="125" showSelectPanel="true" readOnly="true" />
						<ta:selectInput id="aab006" key="登记执照种类" labelWidth="125" collection="AAB006" islevel="true" isMustLeaf="true" readOnly="true" />
						<ta:text id="aab009" key="有效期限（年）" labelWidth="125" validType="number" maxLength="6" readOnly="true" />
					</ta:panel>
					<ta:panel id="fld_swdzxx" key="税务登记信息" fit="true" cols="3">
						<ta:selectInput id="yab240" key="地税征收城市" labelWidth="125" collection="AAB301" islevel="true" isMustLeaf="true" readOnly="true" />
						<ta:text id="aaz066" key="税务机构ID" labelWidth="125" maxLength="20" bpopTipMsg="可输入税务机构ID、税务机构名称、税号查询" readOnly="true" />
						<ta:text id="yae433" key="税务机构名称" labelWidth="125" maxLength="100" readOnly="true" />
						<ta:text id="aab030" key="税号" labelWidth="125" maxLength="20" readOnly="true" />
					</ta:panel>
				</ta:tab>
				<ta:tab id="tb_dwtb" key="单位参保信息">
					<ta:text id="findInsuranceInfo" key="判断是否已经查询单位信息" display="false" value="0" />
					...
					<ta:tabs id="tbs_xzxx" fit="true">
						<ta:tab id="tab_110" key="企业养老保险" cssStyle="overflow:auto">
							<ta:panel id="cbxx_110" key="参保信息" cols="3">
								...
								<ta:date id="110_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="110_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" required="true" issue="true" />
						...
						<ta:tab id="tab_120" key="机关养老保险" cssStyle="overflow:auto">
							<ta:panel id="cbxx_120" key="参保信息" cols="3">
								...
								<ta:date id="120_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="120_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" issue="true" required="true" />
						...
						<ta:tab id="tab_210" key="失业保险" cssStyle="overflow:auto">
							<ta:panel id="cbxx_210" key="参保信息" cols="3">
								...
								<ta:date id="210_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="210_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" issue="true" required="true" />
						...
						<ta:tab id="tab_310" key="医疗保险" cssStyle="overflow:auto">
							<ta:panel id="cbxx_310" key="参保信息" cols="3">
								...
								<ta:date id="310_aab050" key="参保日期" showSelectPanel="true" labelWidth="130" required="true" />
								<ta:date id="310_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" issue="true" required="true" />
						...
						<ta:tab id="tab_330" key="大额医疗" cssStyle="overflow:auto">
							<ta:panel id="cbxx_330" key="参保信息" cols="3">
								...
								<ta:date id="330_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="330_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" issue="true" required="true" />
						...
						<ta:tab id="tab_320" key="公务员补助" cssStyle="overflow:auto">
							<ta:panel id="cbxx_320" key="参保信息" cols="3">
								...
								<ta:date id="320_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="320_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" issue="true" required="true" />
						...
						<ta:tab id="tab_370" key="企业补充" cssStyle="overflow:auto">
							<ta:panel id="cbxx_370" key="参保信息" cols="3">
								...
								<ta:date id="370_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="370_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" issue="true" required="true" />
							...
							<ta:panel id="dwyhxx_370" key="单位银行帐号" cols="2">
								...
								<ta:text id="dw_370_aae010" key="银行账号" labelWidth="120" validType="number" maxLength="40" onChange="fnYhzh('cz_aae010');" />
						...
						<ta:tab id="tab_340" key="离休" cssStyle="overflow:auto">
							<ta:panel id="cbxx_340" key="参保信息" cols="3">
								...
								<ta:date id="340_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="340_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" issue="true" required="true" />
						...
						<ta:tab id="tab_350" key="二乙" cssStyle="overflow:auto">
							<ta:panel id="cbxx_350" key="参保信息" cols="3">
								...
								<ta:date id="350_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="350_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" issue="true" required="true" />
						...
						<ta:tab id="tab_410" key="工伤保险" cssStyle="overflow:auto">
							<ta:panel id="cbxx_410" key="参保信息" cols="3">
								...
								<ta:date id="410_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="410_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" required="true" issue="true" />
						...
						<ta:tab id="tab_510" key="生育保险" cssStyle="overflow:auto">
							<ta:panel id="cbxx_510" key="参保信息" cols="3">
								...
								<ta:date id="510_aab050" key="参保日期" showSelectPanel="true" labelWidth="120" required="true" />
								<ta:date id="510_yae097" key="最大做账期号" showSelectPanel="true" labelWidth="120" required="true" issue="true" />
				...
				<ta:tab id="tb_unitInfo" key="单位变更信息表">
					<ta:text id="findUnitChangeInfo" key="判断是否已经查询" display="false" value="0" />
					<ta:datagrid id="unitChangeInfoGrid" haveSn="true" forceFitColumns="true" height="360">
						<ta:datagridItem id="aae155_unit" key="变更项" align="center" width="250" />
						<ta:datagridItem id="aae123_unit" key="变更前信息" align="center" width="300" formatter="fnChangeNull" />
						<ta:datagridItem id="aae124_unit" key="变更后信息" align="center" width="300" formatter="fnChangeNull" />
						<ta:datagridItem id="aae035_unit" key="变更日期" align="center" width="250" dataAlign="center" />
						<ta:datagridItem id="aae160_unit" key="变更原因" align="center" width="480" hiddenColumn="true" />
					</ta:datagrid>
				</ta:tab>

				<ta:tab id="tb_insuranceInfo" key="险种变更信息表">
					<ta:text id="findInsuranceChangeInfo" key="判断是否已经点击了该tab" display="false" value="0" />
					<ta:datagrid id="unitInsuranceChangeInfo" haveSn="true" forceFitColumns="true" height="360">
						<ta:datagridItem id="aae140" key="险种类型" align="center" width="180" collection="AAE140" />
						<ta:datagridItem id="aae155" key="变更项" align="center" width="230" />
						<ta:datagridItem id="aae123" key="变更前信息" align="center" width="260" formatter="fnChangeNull" />
						<ta:datagridItem id="aae124" key="变更后信息" align="center" width="260" formatter="fnChangeNull" />
						<ta:datagridItem id="aae035" key="变更日期" align="center" width="160" dataAlign="center" />
						<ta:datagridItem id="aae160" key="变更原因" align="center" width="320" hiddenColumn="true" />
					</ta:datagrid>
				</ta:tab>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		//隐藏控件
		Base.hideObj('aae140_110,aae140_120,aae140_210,aae140_310,aae140_320,aae140_330,aae140_340,aae140_350,aae140_370,aae140_410,aae140_510,' + 'tab_110,tab_120,tab_210,tab_310,tab_320,tab_330,tab_340,tab_350,tab_370,tab_410,tab_510,tbs_xzxx');
		//获取变更项的ID设置变更后的颜色
		var par = Base.getValue('unitChangeIds');
		if (par !== '0') {
			cssControl(par, 'red');
		}
	});
	...
	function submitData() {
		...
		if ("" == aab001) {
			Base.alert('没有需要审核的单位维护信息！', 'warn');
			return;
		} else {
			Base.submit('form1', 'maintainEmployerInfoCheckAction!toSave.do');
	...
	function fnSelect(tabid) {
		if (tabid == 'tb_dwtb') {
			if (Base.getValue('findInsuranceInfo') == '0') {
				Base.submit('form1', 'maintainEmployerInfoCheckAction!getInsuranceInfo.do', null, null, false, fnSuccess, null);
				Base.setValue('findInsuranceInfo', '1');
			}
		}
		if (tabid == 'tb_unitInfo') {
			if (Base.getValue('findUnitChangeInfo') == '0') {
				Base.submit('form1', 'maintainEmployerInfoCheckAction!getUnitChangeInfo.do');
				Base.setValue('findUnitChangeInfo', '1');
			}
		}
		if (tabid == 'tb_insuranceInfo') {
			if (Base.getValue('findInsuranceChangeInfo') == '0') {
				Base.submit('form1', 'maintainEmployerInfoCheckAction!getInsuranceChangeInfo.do');
				Base.setValue('findInsuranceChangeInfo', '1');
			}
		}
	}

	//回调渲染  将null或空设置成无
	function fnChangeNull(row, cell, value, columnDef, dataContext) {
		if ((value == '') || (value == 'null')) {
			return '无';
		}
		return value;
	...
	function fnSuccess() {
		...
		for (i = 0; i < strs.length; i++) {
			...
			if (newAae140 == 'aae140') {
				var cb_xx = '#cb_' + strs[i].substring(0, 3) + '+label';
