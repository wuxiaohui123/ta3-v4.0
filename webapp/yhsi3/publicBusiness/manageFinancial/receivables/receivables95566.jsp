	...
	<body class="no-scrollbar">
		...
		<ta:form id="form1" fit="true">
			...
			<ta:panel id="pnlFina" key="收款信息" cols="3" expanded="false" scalable="false" height="80">
				...
				<ta:selectInput id="aad005" key="收款类型" labelWidth="160" collection="AAD005" value="11" filter="10,11" reverseFilter="true" isAutoExtend="true" />
			...
			<ta:tabs fit="true">
				<ta:tab id="tab1" key="单据信息">
					<ta:datagrid id="danjuGrid" fit="true" snWidth="30" haveSn="true" selectType="checkbox" forceFitColumns="true" onSelectChange="selectChage">
						...
						<ta:datagridItem id="aae019" key="应收金额" dataAlign="right" align="center" maxChart="5" totals="sum" formatter="fnFormatter"
							tatalsTextShow="false" />
...
<script type="text/javascript">
	...
	function fnSelect1(){
        ...
        Base.submit("pnlJS","receivables95566Action!toCheckAAZ010.do");
	    ...
	    //Base.submit("pnlJS","receivables95566Action!Query.do");
	}
	//查询
	function fnSelect2(){
	    Base.clearGridData("danjuGrid");
	...
	function fnSave(){
		...
		if(rows.length==0){
		    ...
		    if(!isTrue){
		       ...
		       Base.submit("pnlFina,pnlJS","receivables95566Action!toSave.do",param);			    
		    }else if(infoGrid.length!=0){
		       var param={};
			   ...
			   if(aae019!=yad003){
			       ...
			       Base.submit("","receivables95566Action!toSaveInfo.do",param); 
			   }	
		    }
		}
	...
	function fnSave2(){
		...
		Base.submit("pnlFina","receivables95566Action!toSave2.do",param,null,false,function(){
    ...
    function queryByAaz288(){
       ...
       Base.submit("aaz288","receivables95566Action!queryByAaz288.do",{"dto['aaz010']":aaz010});
    }
    //统计待处理金额总计
    ...
    function submitData() {
		...
		Base.submit("pnlJS", "receivables95566Action!toMZ.do", prm, null, null,
				function() {
				});
	}
