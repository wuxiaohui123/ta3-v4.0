		...
		<ta:tabs id="tabs" fit="true">
			<ta:tab key="个人基本信息和参保信息" id="tab1">
				...
				<ta:panel id="grcbxx" key="个人参保信息" expanded="false" scalable="false" fit="true">
					<ta:datagrid id="insurlist" enableColumnMove="true" selectType="radio" haveSn="true" border="true" snWidth="20" fit="true">
...
<script type="text/javascript">
	...
	//保存
	function toSave() {
		Base.submit("form1", "insurTransferApplyYbCheckAction!toSave.do");
	}
	...
	function toPrint() {
		...
		if (aaz002 == '' || aaz002 == null) {
			alert("请获取到aaz002,请检查为空原因！");
			return;
		}
		if (aaz002 == '' || aaz002 == null) {
			alert("请获取到yae099,请检查为空原因！");
			return;
		}
		var prm = "yae099=" + yae099 + ";aaz002=" + aaz002;
