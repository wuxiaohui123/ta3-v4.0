...
<body>
	...
	<ta:form id="form1" fit="true">
		...
		<ta:tabs id="tabsPersonbushou" fit="true">
			<ta:tab id="bushouInfo" key="补欠费明细">
				<ta:datagrid id="interruptInfo" haveSn="true" fit="true" forceFitColumns="true">
			        <ta:datagridItem id="aac003" key="姓名" align="center" dataAlign="left" />
					<ta:datagridItem id="aae044" key="单位名称" align="center" dataAlign="left" />
...
<script type="text/javascript">
	...
	function fnSave(){
		...
		if(""==rows){
			Base.alert('没有需要审核的个人补欠费信息!','warn');
			return;
		}else{
			Base.submit('form1','adjustpersonCheckAction!toSave.do',param);
