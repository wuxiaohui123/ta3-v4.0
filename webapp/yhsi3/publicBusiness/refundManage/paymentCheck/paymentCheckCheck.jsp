			...
			<ta:tab id="bushouInfo" key="核定信息">
				<ta:datagrid id="interruptInfo" haveSn="true" fit="true">
				  <ta:datagridItem field="aac001" key="个人ID" align="center" dataAlign="left" />
						...
						<ta:datagridItem field="aae140" key="险种类型" width="160" collection="aae140" align="center" dataAlign="left" />
						...
						<ta:datagridItem field="aae016" key="复核标志 " align="center" dataAlign="left" />
...
<script type="text/javascript">
	...
	function fnSave(){
		...
		if(""==rows){
			Base.alert('没有需要审核的窗口缴费人员核定信息！','warn');
			return;
		}else{
			Base.submit('form1','paymentCheckCheckAction!toSave.do',param);
