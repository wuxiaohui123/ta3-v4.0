...
<body>
	...
	<ta:form id="form1" fit="true">
		...
		<ta:tabs id="tabsPersonbushou" fit="true">
			<ta:tab id="bushouInfo" key="个人实缴退款信息">
				<ta:datagrid id="tuikuanInfo" haveSn="true" fit="true" >
...
<script type="text/javascript">
	...
	//保存审核信息
	function fnSave(){
		var rows = Base.getGridData('tuikuanInfo');
		var param = {};
		param.tuikuanInfo = Ta.util.obj2string(rows);
		if(""==rows){
			Base.alert('没有需要审核的个人实缴退款信息!','warn');
			return;
		}else{
			Base.submit('form1','paymentRefundCheckAction!toSave.do',param);
