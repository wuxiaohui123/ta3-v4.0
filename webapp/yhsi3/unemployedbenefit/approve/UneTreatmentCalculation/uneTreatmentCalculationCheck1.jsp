...
<body>
	<ta:pageloading />
	<ta:toolbar id="tlb">
		<ta:button id="saveBtn" key="待遇新增审核[S]" icon="xui-icon-spotSave" onClick="transProcess();"  asToolBarItem="true" />
		<ta:button id="printBtn3" icon="xui-icon-spotPrint" key="打印失业登记卡" onClick="printDJK()" asToolBarItem="true" display="false" />
	...
	<ta:form  id="form1" fit="true">
		...
		<ta:panel key="人员基本信息" cols="3" id="jbxxfset" >
		   <ta:text id="aac001" key="人员ID"  labelWidth="130"  readOnly="true" />
		    ...
		    <ta:number key="联系电话" id="aae005" labelWidth="130"  readOnly="true" />
...
<script type="text/javascript">	
	...
	function transProcess(){		
		Base.submit("form1", "uneTreatmentCalculationCheck1Action!transProcess.do");
	}
