...
<body>
	...
	<ta:form id="form1" cssStyle="overflow:auto;" fit="true">
		...
		<ta:panel id="zyxx" key="转移前信息" bodyStyle="margin:0px" cols="3">
			<ta:selectInput id="sfbz" key="是否区直转入" labelWidth="130" collection="SFBZ" />
			<ta:text id="yie014" key="区直转出证明号" labelWidth="130" display="false" />
			<ta:date id="ajc090" key="失业时间" labelWidth="130" />
			<ta:selectInput id="ajc093" key="失业原因" labelWidth="130" collection="AJC093" />
			<ta:number id="ajc071" key="参保缴费月数" max="500" min="1" labelWidth="130" alignLeft="true" />
			<ta:number id="ajc099" key="剩余享受月数" max="50" min="1" labelWidth="130" alignLeft="true" />
			<ta:text id="aac071" key="所在单位名称" labelWidth="130" />
			<ta:text id="aac072" key="社保机构名称" labelWidth="130" />
			<ta:text id="aac073" key="社保机构帐号" labelWidth="130" />
			<ta:text id="aac074" key="社保机构邮政编码" labelWidth="130" />
...
<script type="text/javascript">
	...
	//保存经办信息
	function submitData() {
		Base.submit("form1", "transferIntoCheck1Action!toSave.do", null, null, null, null);
	}
