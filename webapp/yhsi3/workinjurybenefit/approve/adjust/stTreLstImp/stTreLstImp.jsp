...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="margin: 0px; padding: 1px;" class="no-scrollbar"
		...
		<ta:toolbar id="tlb">
			...
			<ta:submit id="btnImp" url="stTreLstImpAction!upfile.do" key="导入[I]" icon="xui-icon-spotAdd" hotKey="ctrl+I" asToolBarItem="true" submitIds="form1" isSyncSubmit="true" />
				...
				<ta:box cols="3">
					...
					<div style="width: 15%; padding-left: 500px">
						<a onmouseover="this.style.color = 'RED';"
							...
							id="dto(xzmb)_label" href="stTreLstImpAction!downFile.do"
				...
				<ta:tabs id="tabs" height="400">
					<ta:tab id="tab1" key="导入成功">
						<ta:datagrid id="tzxxGrid1" haveSn="true" height="280"
							...
							<ta:datagridItem id="yic008" key="伤残或护理等级" width="200" collection="SCHLDJ" align="center" ></ta:datagridItem>
...
<script type="text/javascript">
	...
	//查询信息
    function query(){
	    Base.submit("form1","stTreLstImpAction!queryInfo.do");
	...
	function fn_aaa134(){
	    ...
	    Base.submit("form1","stTreLstImpAction!queryaaa134.do");
	}
	//保存信息
function submitData(){
	...
	Base.submit("from1,tzxxGrid1","stTreLstImpAction!toSave.do",prm,null,null,function(data){
