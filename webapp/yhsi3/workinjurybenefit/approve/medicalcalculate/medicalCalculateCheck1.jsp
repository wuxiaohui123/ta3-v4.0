...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="margin:0px;padding:0px">
		...
		<ta:toolbar id="tlb">
			...
			<ta:button id="printBtn" icon="xui-icon-spotPrint" key="打印" asToolBarItem="true" display="false"  onClick="print()"/>
		...
		<ta:form id="form1" fit="true">
			...
			<ta:panel id="gsfzqjfbxDetailHisPanel" key="工伤辅助器具详细信息(未核定)">
				<ta:datagrid id="gsfzqjfbxDetailHisGrid" forceFitColumns="true" haveSn="true" height="80px">
					...
					<ta:datagridItem id="aae0441" key="辅助器具配置机构名称" />
					<ta:datagridItem id="aaz105" key="辅助器具项目ID" hiddenColumn="false" />
					<ta:datagridItem id="ala020" key="辅助器具项目名称" />
					<ta:datagridItem id="akc225" key="辅助器具单价" />
					<ta:datagridItem id="akc226" key="辅助器具配置数量" />
					<ta:datagridItem id="alc010" key="辅助器具配置时间" />
					<ta:datagridItem id="faae196" key="辅助器具发票张数" />
				</ta:datagrid>
			</ta:panel>
...
<script type="text/javascript">
	...
	function print(){
		...
		var alc031 = data[0].alc031;
		if(alc031<"2004-01-01"){
		    $("#report1_printIFrame").attr("src","<%=path%>/reportServlet?action=2&name=report1&reportFileName=GS_zyfyjsb9.raq&"+
				"srcType=file&savePrintSetup=yes&appletJarName=runqian/runqianReport4Applet.jar%2Crunqian/dmGraphApplet.jar&"+
				"serverPagedPrint=no&mirror=no&"+
				"paramString=aac001="+aac001+";aaz002="+aaz002);
		}else{
		    $("#report1_printIFrame").attr("src","<%=path%>/reportServlet?action=2&name=report1&reportFileName=GS_zyfyjsb.raq&"+
				"srcType=file&savePrintSetup=yes&appletJarName=runqian/runqianReport4Applet.jar%2Crunqian/dmGraphApplet.jar&"+
				"serverPagedPrint=no&mirror=no&"+
				"paramString=aac001="+aac001+";yab003="+yab003+";aaz002="+aaz002);
		}		
	}
