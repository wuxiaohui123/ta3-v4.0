...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>MedicalSubsidyCalculateCheck1</title>
	...
	<body>
		<ta:pageloading />
		<ta:toolbar id="tlb">
			<ta:button id="saveBtn" key="审核[S]" icon="icon-save" hotKey="S" onClick="submitData();" asToolBarItem="true" />
		...
		<ta:form id="form1" fit="true">
			...
			<ta:panel id="gsxx" key="人员工伤信息" height="83px">
				<ta:datagrid id="gsxxList" fit="true" forceFitColumns="true"> 
					...
					<ta:datagridItem id="alc040" key="死亡日期">
					</ta:datagridItem>
...
function submitData(){
	Base.submit("form1", "medicalSubsidyCalculateCheck1Action!toSave.do");
}
